...
describe ('English user flow input test', () => {
  it.skip('When I visit the MFB landing page I should see the step progression display Step 0 of 21', () => {
    cy.visit('http://localhost:3000')
      .get('p[class="step-progress-title"]')
      .should("contain", 'Step 0 of 21');
  });

  it.skip('When I visit the MFB landing page and click on the Continue button, it should navigate me to' +
  ...
  it.skip('When I click on the Prev button in the Disclaimer' +
  ...
  it.skip('Happy path: When I click on the Disclaimer checkbox in step-1, and click on Continue' +
  ...
  it.skip('Sad path: When I just click on Continue button on the Disclaimer' +
  ...
  it.skip('Age question happy path: When I enter my age and click on Continue I should be navigated to the next step', () => {
