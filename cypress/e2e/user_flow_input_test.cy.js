...
describe('English user flow input test', () => {
  ...
  it(
    'When I visit the MFB landing page and click on the Continue button, it should navigate me to' +
  ...
  it(
    'When I click on the Prev button in the Disclaimer' +
  ...
  it(
    'Happy path: When I click on the Disclaimer checkbox in step-1, and click on Continue' +
  ...
  it('Age question sad path 1: If I just click on the Continue button I should see an error', () => {
    cy.visit(`http://localhost:3000/step-${stepDirectory.age}`)
      ...
      .click()
      .get('p')
      .should('contain', 'Please enter a valid age (13-130)');
  });
  ...
  it('Income question happy path 1: When I click `Yes`, fill out all three income fields for both of my income sources and click on Continue I should be navigated to the next step', () => {
    ...
    cy.visit(`http://localhost:3000/step-${stepDirectory.hasIncome}`)
      ...
      .first()
      .click()
      .get('div[aria-labelledby="income-type-label"]')
      .click()
      .get('li')
      .eq(1)
      .click()
      .get('div[aria-labelledby="income-frequency-label income-frequency"]')
      .click()
      .get('li')
      .eq(2)
      .click()
      ...
      .get('button')
      .should('contain', 'Add another income')
      .first()
      .click()
      .get('div[aria-labelledby="income-type-label"]')
      .click()
  ...
  it('Income question happy path 2: Removing an added income source', () => {
    cy.visit(`http://localhost:3000/step-${stepDirectory.hasIncome}`)
      ...
      .first()
      .click()
      .get('p[class="question-label"]')
      .contains('If you receive another type of income, select it below.')
      .should('not.exist');
  });
