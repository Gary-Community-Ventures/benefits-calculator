...
const incomeOptions = {
  ...
  unemployment: (
    <FormattedMessage id='incomeOptions.unemployment' defaultMessage='Unemployment Benefits' />
  ),
  cashAssistance: (
    <FormattedMessage id='incomeOptions.cashAssistance' defaultMessage='Cash Assistance Grant' />
  ),
  childSupport: (
    <FormattedMessage id='incomeOptions.childSupport' defaultMessage='Child Support (Received)' />
  ),
  sSI: (
    <FormattedMessage id='incomeOptions.sSI' defaultMessage='Supplemental Security Income (SSI)' />
  ),
  sSDisability: (
    <FormattedMessage
  ...
  veteran: (
    <FormattedMessage id='incomeOptions.veteran' defaultMessage="Veteran's Pension or Benefits" />
  ),
  pension: (
    <FormattedMessage
  ...
  workersComp: (
    <FormattedMessage id='incomeOptions.workersComp' defaultMessage="Worker's Compensation" />
  ),
  ...
  gifts: (
    <FormattedMessage id='incomeOptions.gifts' defaultMessage='Gifts/Contributions (Received)' />
  ),
