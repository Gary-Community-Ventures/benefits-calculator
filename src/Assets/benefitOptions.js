...
const benefitOptions = {
  ...
  nslp: (
    <FormattedMessage id="benefitOptions.nslp" defaultMessage="Free school meals (National School Lunch Program)" />
  ),
  ctc: (
    <FormattedMessage
  ...
  rtdlive: <FormattedMessage id="benefitOptions.rtdlive" defaultMessage="Discounted RTD fares (RTD LiVE)" />,
  cccap: (
    <FormattedMessage
  ...
  mydenver: (
    <FormattedMessage id="benefitOptions.mydenver" defaultMessage="Reduced-cost youth programs (MY Denver Card)" />
  ),
  leap: <FormattedMessage id="benefitOptions.leap" defaultMessage="Help with winter heating bills (LEAP)" />,
};
