...
const expenseOptions = {
  ...
  childSupport: (
    <FormattedMessage id='expenseOptions.childSupport' defaultMessage='Child Support (Paid)' />
  ),
  dependentCare: (
    <FormattedMessage id='expenseOptions.dependentCare' defaultMessage='Dependent Care' />
  ),
  ...
  otherUtilities: (
    <FormattedMessage id='expenseOptions.otherUtilities' defaultMessage='Other Utilities' />
  ),
  auto: (
    <FormattedMessage
  ...
  studentLoans: (
    <FormattedMessage id='expenseOptions.studentLoans' defaultMessage='Student Loans' />
  ),
  creditCard: <FormattedMessage id='expenseOptions.creditCard' defaultMessage='Credit Card Debt' />,
  personalLoan: (
    <FormattedMessage id='expenseOptions.personalLoan' defaultMessage='Personal Loan' />
  ),
};
