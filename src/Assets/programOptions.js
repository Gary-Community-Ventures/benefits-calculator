const programs = {
  ...
  wic: {
    ...
    programDescription: 'Free healthy food, counseling about healthy eating, breastfeeding support, and referrals for women, infants, and children under five.',
  ...
  eitc: {
    ...
    programDescription: 'Tax credit worth up to $6,728 for low- to moderate-income workers and families, especially those with children.',
  ...
  childAndDependentCareCredit: {
    ...
    programDescription: 'Tax credit for people who paid someone to care for their dependents so they could work or look for work.',
  ...
  coERAP: {
    ...
    programDescription: 'The Colorado Emergency Rental Assistance Program (ERAP) can help cover rent as far back as April 2020.',
  ...
  acp: {
    ...
    programDescription: 'Get a monthly discount up to $30 on internet service and up to $100 off for a laptop, tablet, or computer.',
  ...
  leap: {
    ...
    programDescription: 'Helps eligible hard-working Colorado families, seniors and individuals pay a portion of their winter home heating costs.',
